...
var o16852 = temp__5802__auto__;
var temp__5802__auto____$1 = (o16852["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o16853 = temp__5802__auto____$1;
return (o16853["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16179__auto__ = f;
return (o__16179__auto__["toString"]).call(o__16179__auto__);
} else {
return "";
}
}catch (e16854){var _ = e16854;
return "";
}});
...
try{var o__16179__auto___16856 = t;
(o__16179__auto___16856["cljs$lang$ctorPrWriter"]).call(o__16179__auto___16856,t,writer);
}catch (e16855){var __16857 = e16855;
}
...
var char_code = (function (){var o__16179__auto__ = (new String(char$));
return (o__16179__auto__["charCodeAt"]).call(o__16179__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16179__auto__ = String;
return (o__16179__auto__["fromCharCode"]).call(o__16179__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16858 = num_code;
switch (G__16858) {
case (1):
return (185);
...
var o__16179__auto__ = String;
return (o__16179__auto__["fromCharCode"]).call(o__16179__auto__,superscript_code);
});
/**
...
}catch (e16860){var _e__16186__auto__ = e16860;
return false;
}})())){
...
var vec__16861 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16861,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16866){
var vec__16867 = p__16866;
var ns_detector = cljs.core.nth.call(null,vec__16867,(0),null);
...
var G__16873 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16874 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16873;
remaining_tokens = G__16874;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16864){
var G__16865 = cljs.core.first.call(null,seq16864);
var seq16864__$1 = cljs.core.next.call(null,seq16864);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16865,seq16864__$1);
}));
...
var vec__16878 = cljs.core.split_with.call(null,(function (p1__16877_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16877_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16878,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16878,(1),null);
...
var vec__16884 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16884,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16884,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16887 = cljs.core.rest.call(null,remaining_tokens);
var G__16888 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16887;
name_tokens = G__16888;
continue;
} else {
...
var vec__16891 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16891,(0),null);
var arity = cljs.core.nth.call(null,vec__16891,(1),null);
var vec__16894 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16894,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16894,(1),null);
var vec__16897 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16897,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16897,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16897,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16897,(3),null);
...
var vec__16903 = result;
var munged_ns = cljs.core.nth.call(null,vec__16903,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16903,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16903,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16903,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16903,(4),null);
var arity = cljs.core.nth.call(null,vec__16903,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__16907 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__16907,(0),null);
var args = cljs.core.nth.call(null,vec__16907,(1),null);
var vec__16910 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16910,(0),null);
var name = cljs.core.nth.call(null,vec__16910,(1),null);
...
var G__16913 = (arity + (1));
var G__16914 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16915){
var vec__16916 = p__16915;
var arity = cljs.core.nth.call(null,vec__16916,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16916,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16919_SHARP_){
return cljs.core.get.call(null,arities,p1__16919_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__16920_SHARP_){
return cljs.core.drop.call(null,(2),p1__16920_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___16927 = arguments.length;
var i__5727__auto___16928 = (0);
while(true){
if((i__5727__auto___16928 < len__5726__auto___16927)){
args__5732__auto__.push((arguments[i__5727__auto___16928]));

var G__16929 = (i__5727__auto___16928 + (1));
i__5727__auto___16928 = G__16929;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16923){
var vec__16924 = p__16923;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16924,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16921){
var G__16922 = cljs.core.first.call(null,seq16921);
var seq16921__$1 = cljs.core.next.call(null,seq16921);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16922,seq16921__$1);
}));
...
var map__16932 = options;
var map__16932__$1 = cljs.core.__destructure_map.call(null,map__16932);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16932__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16932__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16932__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16932__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16933 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16933,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16933,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16933,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16933,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16933,(4),null);
var arity = cljs.core.nth.call(null,vec__16933,(5),null);
...
var o__16179__auto__ = f;
return (o__16179__auto__["getBasis"]).call(o__16179__auto__);
});
/**
...
}catch (e16936){var _e__16186__auto__ = e16936;
...
var G__16937 = (obj[cljs.core.first.call(null,path)]);
var G__16938 = cljs.core.rest.call(null,path);
obj = G__16937;
path = G__16938;
continue;
} else {
...
var _STAR_ = (function (accum,p__16939){
var vec__16940 = p__16939;
var bit = cljs.core.nth.call(null,vec__16940,(0),null);
var protocol = cljs.core.nth.call(null,vec__16940,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16943){
var vec__16944 = p__16943;
var ns = cljs.core.nth.call(null,vec__16944,(0),null);
var name = cljs.core.nth.call(null,vec__16944,(1),null);
var selector = cljs.core.nth.call(null,vec__16944,(2),null);
...
var post_process = (function (p__16948){
var vec__16949 = p__16948;
var munged_name = cljs.core.nth.call(null,vec__16949,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16949,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16947_SHARP_){
return (obj[cljs.core.first.call(null,p1__16947_SHARP_)]);
}),sorted_matches);
