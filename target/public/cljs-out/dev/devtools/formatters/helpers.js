...
var G__16954 = devtools.prefs.pref.call(null,v);
v = G__16954;
continue;
} else {
return v;
...
}catch (e16955){var _e__16186__auto__ = e16955;
return false;
}})();
...
}catch (e16957){var _e__16186__auto__ = e16957;
return false;
}})();
...
}catch (e16959){var _e__16186__auto__ = e16959;
return false;
}}
}
});
...
var vec__16961 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16961,(0),null);
var name = cljs.core.nth.call(null,vec__16961,(1),null);
...
return cljs.core.some.call(null,(function (p1__16964_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16964_SHARP_);
}),template);
});
