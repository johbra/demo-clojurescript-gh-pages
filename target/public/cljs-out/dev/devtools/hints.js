...
var map__19455 = top_item;
var map__19455__$1 = cljs.core.__destructure_map.call(null,map__19455);
var file = cljs.core.get.call(null,map__19455__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19455__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19455__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e19454){var _e = e19454;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___19456 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___19456)){
var seen_errors_19457 = temp__5802__auto___19456;
if(cljs.core.truth_(seen_errors_19457.has(self))){
} else {
seen_errors_19457.add(self);

var temp__5804__auto___19458 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___19458)){
var sense_19459 = temp__5804__auto___19458;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19459)].join(''));
} else {
}
}
} else {
